...
// (INTEGRATION_ENCRYPTION_KEY) before it lands here. One integration per
// (organization, kind, provider).
export const integration = pgTable(
  ...
  (t) => [unique("integration_org_kind_provider_unique").on(t.organizationId, t.kind, t.provider)],
)
